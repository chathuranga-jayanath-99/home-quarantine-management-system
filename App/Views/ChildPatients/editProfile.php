...
<head>
    ...
    <title>Edit Profile - Child Patient - Home Isolation System</title>
        ...
        <div class="col-lg-12 col-xl-10">
            ...
            <div class="card-body p-md-5">
                ...
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                    ...
                    <form id="log-form" action="<?php echo URLROOT?>/child-patient/edit-profile" method='POST'>
                        <div class="d-flex flex-row align-items-center mb-4">
                            <i class="fa fa-user fa-lg me-3 fa-fw"></i>
                            <div class="form-outline flex-fill mb-0">
                                <input onchange="nameChange()" class="form-control" type="text" name="name" value="<?php echo $data['name']?>" placeholder="Name" required>
                        ...
                        <div class="d-flex flex-row align-items-center mb-4">
                            ...
                            <div class="form-outline flex-fill mb-0">
                                <input onchange="emailChange()" class="form-control" type="text" name="email" value="<?php echo $data['email']?>" placeholder="Email" required>
                        ...
                        <div class="d-flex flex-row align-items-center mb-4">
                            ...
                            <div class="form-outline flex-fill mb-0">
                                <input onchange="contactNoChange()" class="form-control" type="text" name="contact_no" value="<?php echo $data['contact_no']?>" placeholder="Contact No" required>
                        ...
                        <div class="d-flex flex-row align-items-center mb-4">
                            ...
                            <div class="form-outline flex-fill mb-0">
                                <input onchange="addressChange()" class="form-control" type="text" name="address" value="<?php echo $data['address']?>" placeholder="Address" required>
