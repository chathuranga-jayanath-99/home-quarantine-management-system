                ...
                <div class="card-body p-md-5">
                    <div class="row justify-content-center">
                        <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
							<h1 class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Record History</h1>
                            <h5 class="text-center h5 fw-bold mb-5 mx-1 mx-md-4 mt-4">No Record Found</h1>
                                <div class="text-center">
                                    <div>
                                        <a href="<?php echo URLROOT; ?>/child-patient"><button class="btn btn-warning">Back to Home</button></a>
                                    </div>
                                </div>
                        </div>
