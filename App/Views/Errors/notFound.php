                ...
                <div class="card-body p-md-5">
                    <div class="row justify-content-center">
                        <div class="col-md-10 col-lg-6 col-xl-7 order-2 order-lg-1">
							<h1 class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4 text-danger">Error 4<div class="spinner-border text-danger" role="status"></div>4!</h1>
                            <h2 class="text-center h2 fw-bold mb-5 mx-1 mx-md-4 mt-4">Page Not Found!</h2>
                        ...
                        <div class="col-md-8 col-lg-5 col-xl-4 d-flex align-items-center order-1 order-lg-2">
                            <div>
                                <div>
                                    <img src="https://static.vecteezy.com/system/resources/previews/003/058/565/original/website-error-404-vector.jpg" width=400 class="img-fluid" alt="Sample image">
                                </div>
                            </div>
                        </div>
                    </div>
