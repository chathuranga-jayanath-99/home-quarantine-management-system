...
<meta charset="UTF-8">
    ...
    <title>Request Error - Home Isolation System</title>
                ...
                <div class="card-body p-md-5">
                    <div class="row justify-content-center">
                        <div class="col-md-10 col-lg-6 col-xl-7 order-2 order-lg-1">
							<h1 class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4 text-danger">Request Error</h1>
                            <h5 class="text-center h5 fw-bold mb-5 mx-1 mx-md-4 mt-4">An error has occured while processing the request.</h5>
                        ...
                        <div class="col-md-8 col-lg-5 col-xl-4 d-flex align-items-center order-1 order-lg-2">
                            <div>
                                <div>
                                    <img src="https://cdn.dribbble.com/users/2130329/screenshots/6621836/jiomoney_somethingwentwrong-01.png" width=400 class="img-fluid" alt="Sample image">
                                </div>
                            </div>
                        </div>
                    </div>
