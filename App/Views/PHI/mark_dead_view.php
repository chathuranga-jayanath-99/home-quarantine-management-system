          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <h2 class="text-center h3 fw-bold mb-5 mx-1 mx-md-4 mt-4">MARK DEATHS</h2>
                <form action="<?php echo URLROOT?>/PHI/markdead" method='POST'>
              ...
              <!-- https://image.freepik.com/free-vector/amarena-cherry-flower-from-pomona-italiana-illustration_53876-43226.jpg -->
                    <img src="https://image.freepik.com/free-vector/rest-peace_23-2148011278.jpg" width=400 height=400 class="img-fluid" alt="Sample image"> 
              </div>
              </div>
            </div>
          </div>
