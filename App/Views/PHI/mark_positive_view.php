          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              ...
              <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                    <img src="https://image.freepik.com/free-vector/cute-woman-doctor-holding-syringe-vaccine-hand-drawn-cartoon-art-illustration_56104-966.jpg" width=400 height=400 class="img-fluid" alt="Sample image"> 
              </div>
