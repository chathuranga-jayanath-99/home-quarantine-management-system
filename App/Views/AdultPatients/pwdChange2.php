                ...
                <div class="card-body p-md-5">
                    <div class="row justify-content-center">
                        <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                            ...
                            <form class="mx-1 mx-md-4" action="<?php echo URLROOT?>/adult-patient/password-change" method='POST'>
                                <div class="d-flex flex-row align-items-center mb-4">
                                <i class="fa fa-envelope fa-lg me-3 fa-fw"></i>
                                    <div class="form-outline flex-fill mb-0">
                                        <input class="form-control" type="email" name="email" value="<?php echo $_SESSION['adult_email']; ?>" placeholder="New password" disabled>
                                    </div>
                                </div>
                                <div class="d-flex flex-row align-items-center mb-4">
