...
<head>
    ...
    <script type="text/javascript">
        function loadRecordPage(id) {
            document.getElementById('record-frame').src = "<?php echo URLROOT; ?>/adult-patient/view-record?recordID=" + id;
        }
                ...
                <div class="row">
                    <div class="col-md border-right d-flex flex-column align-items-center">
                        ...
                        <h5 class="text-left h5 fw-bold pb-3">Select a record to view</h1>
                            <form action="<?php echo URLROOT; ?>/adult-patient/records-history" method="post">
                                <div>
                                <?php
                    ...
                    <div class="col-md-10 border-right">
                        <div>
                            <iframe id="record-frame" class="responsive-iframe" src="<?php echo URLROOT; ?>/adult-patient/no-record-selected" style="width: 100%;" onload="resizeRecordPage()"></iframe>
                        </div>
                    </div>
                </div>
                </div>
