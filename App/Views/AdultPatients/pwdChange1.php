        ...
        <div class="col-lg-12 col-xl-10">
            ...
            <div class="card-body p-md-5">
                ...
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                    ...
                    <div>
                        <h6 class="text-center h6 fw-bold mb-5 mx-1 mx-md-4 mt-4">Enter current password</h6>
                    </div>
                    <form action="<?php echo URLROOT?>/adult-patient/password-change" method='POST'>
                        <div class="d-flex flex-row align-items-center mb-4">
                        <i class="fa fa-key fa-lg me-3 fa-fw"></i>
                            <div class="form-outline flex-fill mb-0">
                            <input class="form-control" type="password" name="password" 
                                value="<?php echo $data['password']?>" placeholder="Current password" required>
