                    ...
                    <div class="card text-black" style="border-radius: 25px;">
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                ...
                                <div>
                                        <h4 class="text-center h6 fw-bold mb-5 mx-1 mx-md-4 mt-4">NIC : <?php echo $adultData->NIC ;?></h4>
                                        <h4 class="text-center h6 fw-bold mb-5 mx-1 mx-md-4 mt-4">Patient Name : <?php echo $adultData->name ;?></h4>
                                    </div>
                                    <form action="<?php echo URLROOT?>/adult-patient/active" method="GET">
                                        <div>
