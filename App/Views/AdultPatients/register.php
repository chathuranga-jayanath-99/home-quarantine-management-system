                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <?php }else{?>
                                        <h2 class="text-center h fw-bold mb-5 mx-1 mx-md-4 mt-4"> <?php if (ucfirst($adultData[0]->state) === 'Dead') { ?> This NIC already have an account. But the patient was passed away <?php }else { ?> This NIC already have an active acoount <?php } ?> </h2>  
                                    <div>
                                        <h4 class="text-center h6 fw-bold mb-5 mx-1 mx-md-4 mt-4">NIC : <?php echo $adultData[0]->NIC ;?></h4>
                                        <h4 class="text-center h6 fw-bold mb-5 mx-1 mx-md-4 mt-4">Patient Name : <?php echo $adultData[0]->name ;?></h4>
                                    </div>
