        ...
        <div class="col-lg-12 col-xl-10">
            ...
            <div class="card-body p-md-5">
                ...
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                    ...
                    <form id="log-form" action="<?php echo URLROOT?>/adult-patient/edit-profile" method='POST'>
                        ...
                        <div class="d-flex flex-row align-items-center mb-4">
                            ...
                            <div class="form-outline flex-fill mb-0">
                                <input onchange="emailChange()" class="form-control" type="email" name="email" value="<?php echo $data['email']?>" placeholder="Email" required>
